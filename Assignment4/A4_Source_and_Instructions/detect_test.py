...
PERCENT_TARGET_RADIUS = 0.05 * PERCENT_CENTER_RECT # Minimum target radius to follow
...
def run():
    ...
    # Open a video file
    file = 'Pexels Videos 1572547_540p.mp4'
    vid_cam = cv2.VideoCapture(file)
    ...
    while True:
        ...
        # so the drone doesn't move
            ...
            tgt_cam_coord = {'width':params['y_axe_pos'], 'height':params['x_axe_pos']} # Needed just for drawing objects
...
def get_target_coordinates(vid_cam):
    ...
    # To detect the blue car:
    HSV_LOWER_BOUND = (74, 60, 79)
    HSV_UPPER_BOUND = (109, 222, 195)
